                ...
                <div class="sumary-product single-layout">
                    <div class="media">
                        <ul class="biolife-carousel slider-for"
                            ...
                            <li><img src="{{ asset('assets/images/details-product/p01.jpg') }}" alt="" width="500" height="500"></li>
                            <li><img src="{{ asset('assets/images/details-product/p02.jpg') }}" alt="" width="500" height="500"></li>
                            <li><img src="{{ asset('assets/images/details-product/p03.jpg') }}" alt="" width="500" height="500"></li>
                        ...
                        <ul class="biolife-carousel slider-nav"
                            ...
                            <li><img src="{{ asset('assets/images/details-product/thumb_p01.jpg') }}" alt="" width="88" height="88"></li>
                            <li><img src="{{ asset('assets/images/details-product/thumb_p02.jpg') }}" alt="" width="88" height="88"></li>
                            <li><img src="{{ asset('assets/images/details-product/thumb_p03.jpg') }}" alt="" width="88" height="88"></li>
                    ...
                    <div class="product-attribute">
                        ...
                        <p class="excerpt">Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a. Cras
                            ultricies ligula sed magna dictum porta. Vestibulum ac diam sit amet quam vehicula elementum sed
                            sit amet dui. Cras ultricies ligula sed magna dictum porta. Mauris blandit aliquet elit, eget
                ...
                <div class="product-tabs single-layout biolife-tab-contain">
                    <div class="tab-head">
                        <ul class="tabs">
                            <li class="tab-element active"><a href="#tab_1st" class="tab-link">Products
                                    Descriptions</a></li>
                            <li class="tab-element"><a href="#tab_2nd" class="tab-link">Addtional information</a>
                            </li>
                            <li class="tab-element"><a href="#tab_3rd" class="tab-link">Shipping & Delivery</a>
                            </li>
                    ...
                    <div class="tab-content">
                        <div id="tab_1st" class="tab-contain desc-tab active">
                            <p class="desc">Quisque quis ipsum venenatis, fermentum ante volutpat, ornare enim.
                                Phasellus molestie risus non aliquet cursus. Integer vestibulum mi lorem, id hendrerit ante
                                lobortis non. Nunc ante ante, lobortis non pretium non, vulputate vel nisi. Maecenas dolor
                                elit, fringilla nec turpis ac, auctor vulputate nulla. Phasellus sed laoreet velit.
                                ...
                                <div class="row">
                                    <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
                                        <div class="rating-info">
                                            <p class="index"><strong class="rating">4.4</strong>out of 5
                                            </p>
                                            <div class="rating">
                                                <p class="star-rating"><span class="width-80percent"></span></p>
                                            </div>
                                            ...
                                            <div class="comment-container">
                                                <div class="row">
                                                    <div class="comment-content col-lg-8 col-md-9 col-sm-8 col-xs-12">
                                                        <p class="comment-in"><span class="post-name">Quality is
                                                                our way of life</span><span
                                                                class="post-date">01/04/2018</span></p>
                                                        <div class="rating">
